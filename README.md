...
1. **[antygravity.md](./antygravity.md)**: Details the internal folder layout, Conversation ID (UUID) matching, and the structure of brain files (artifacts, scratch spaces, and the JSON Lines `transcript.jsonl` chat log).
2. **[antigravity_compatibility.md](./antigravity_compatibility.md)**: Documents database/file formats across different versions (Desktop App vs. CLI vs. IDE Integration) and highlights cross-compatibility.
...
For more details on migration procedures and compatibility workarounds, see [antigravity_compatibility.md](./antigravity_compatibility.md).
